  ...
  return (
    <div className="mt-[4rem] mb-[6rem]">
      ...
      <div className="flex flex-col items-center mt-[4rem] space-y-10">
        {/* First Row of Icons */}
        <div className="flex flex-wrap justify-center text-[#4B5563] gap-4 sm:gap-[2rem] md:gap-[4rem]">
          {[
            ...
            <div className="flex flex-col items-center hover:scale-110 transform transition-all duration-300" key={alt}>
              <img src={src} alt={alt} className="h-12 w-12 sm:h-10 sm:w-10" />
